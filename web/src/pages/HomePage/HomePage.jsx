  ...
  return (
    <>
      ...
      <Box display="flex" flexDirection='column' justifyContent="center" alignItems="center" minHeight="100vh">
        <Typography variant='h2' component='h2' align='center' style={{ backgroundColor: '#2D9596', padding: '15px', width: '65%', borderRadius: '25px' , color: '#F1FADA', fontSize: '56px', fontStyle: 'normal', fontWeight: '600'}}>
          Code Translator
        </Typography>
        ...
        <Typography paragraph='true' style={{ backgroundColor: '#2D9596', padding: '25px', marginTop: '20px', marginBottom: '0px', width: '65%', borderRadius: '25px', color: '#F1FADA', fontSize: '28px', fontStyle: 'normal', fontWeight: '300'}}>
          ...
          <List dense='true' disablePadding='true' sx={{ listStyleType: 'disc', pl: 4, marginTop: '5px', marginBottom: '0px'}}>
            <ListItem dense='true' disablePadding='true' sx={{ display: 'list-item' }}>
              C++
            </ListItem>
            <ListItem dense='true' disablePadding='true' sx={{ display: 'list-item' }}>
              C
        ...
        <Typography paragraph='true' style={{ backgroundColor: '#2D9596', padding: '25px', marginTop: '20px', marginBottom: '20px', width: '65%', borderRadius: '25px', color: '#F1FADA', fontSize: '28px', fontStyle: 'normal', fontWeight: '300'}}>
          ...
          <List dense='true' disablePadding='true' sx={{ listStyle: 'decimal', pl: 4, marginTop: '5px', marginBottom: '0px'}}>
            <ListItem dense='true' disablePadding='true' sx={{ display: 'list-item' }}>
