      ...
      <Typography variant='h2' component='h2' align='center' style={{color: theme.palette.text.secondary, fontSize: '52px', fontStyle: 'normal', fontWeight: '600'}}>Documentation</Typography>
      {
        ...
        >
          <Box display="flex" flexDirection='column' justifyContent="center" alignItems="center">
            ...
            <Box style={{ padding: '25px', paddingBottom: '0px', marginTop: '20px', marginBottom: '0px'}} sx={ isDesktopOrLaptop ? { width: '85%' } : { width: '95%' }}>
            ...
            <Typography data-testid='whatgpt' component="span" style={{ padding: '25px', marginTop: '20px', marginBottom: '20px', color: theme.palette.text.primary, fontSize: '24px', fontStyle: 'normal', fontWeight: '300'}} sx={ isDesktopOrLaptop ? { width: '85%' } : { width: '95%' }}>
            ...
            <Typography data-testid='howgpt' component="span"  style={{ padding: '25px', marginTop: '20px', marginBottom: '20px', borderRadius: '20px', color: theme.palette.text.secondary, fontSize: '24px', fontStyle: 'normal', fontWeight: '300'}} sx={ isDesktopOrLaptop ? { width: '85%' } : { width: '95%' }}>
              <Typography variant='h4' style={{ padding: '0px', margin: '0px', color: theme.palette.text.secondary, fontSize: '32px', fontStyle: 'normal', fontWeight: '550'}}>
                How do we use GPT-3?
              </Typography>
