  ...
  return (
    <>
      {questions.map((question) => (
        <p style={{margin: 0}} key={question.id}>
          ...
          <Accordion sx={{bgcolor: theme.palette.text.success, width: '100%', border: '1px solid'}} expanded={expanded === 'panel'+question.id} onChange={handleChange('panel'+question.id)}>
